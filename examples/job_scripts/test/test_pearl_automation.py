...
@patch("examples.job_scripts.pearl_automation.sys.argv", ["pearl_automation.py", "--username", "u", "--password", "p"])
...
@patch("examples.job_scripts.pearl_automation.sys.argv", ["pearl_automation.py", "--username", "", "--password", ""])
