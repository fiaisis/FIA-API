...
@patch("fia_api.scripts.pearl_automation.PearlAutomation.authenticate")
@patch("fia_api.scripts.pearl_automation.PearlAutomation.get_runner_image")
@patch("fia_api.scripts.pearl_automation.PearlAutomation.submit_job")
@patch("fia_api.scripts.pearl_automation.PearlAutomation.monitor_job")
@patch("fia_api.scripts.pearl_automation.PearlAutomation.download_results")
