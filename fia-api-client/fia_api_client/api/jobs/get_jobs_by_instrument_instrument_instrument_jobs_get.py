...
from ...models.get_jobs_by_instrument_instrument_instrument_jobs_get_order_by import (
    GetJobsByInstrumentInstrumentInstrumentJobsGetOrderBy,
)
from ...models.get_jobs_by_instrument_instrument_instrument_jobs_get_order_direction import (
...
def _get_kwargs(
    ...
    *,
    ...
    order_by: Union[
        Unset, GetJobsByInstrumentInstrumentInstrumentJobsGetOrderBy
    ] = GetJobsByInstrumentInstrumentInstrumentJobsGetOrderBy.START,
    order_direction: Union[
        Unset, GetJobsByInstrumentInstrumentInstrumentJobsGetOrderDirection
    ] = GetJobsByInstrumentInstrumentInstrumentJobsGetOrderDirection.DESC,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/instrument/{instrument}/jobs",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order_by (Union[Unset, GetJobsByInstrumentInstrumentInstrumentJobsGetOrderBy]):  Default:
            GetJobsByInstrumentInstrumentInstrumentJobsGetOrderBy.START.
        order_direction (Union[Unset,
            GetJobsByInstrumentInstrumentInstrumentJobsGetOrderDirection]):  Default:
            GetJobsByInstrumentInstrumentInstrumentJobsGetOrderDirection.DESC.
