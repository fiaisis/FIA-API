...
T = TypeVar("T", bound="JobWithRunResponse")


@_attrs_define
class JobWithRunResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        run: Union[None, dict[str, Any]]
        if isinstance(self.run, RunResponse):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_run(data: object) -> Union["RunResponse", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                ...
                pass
            return cast(Union["RunResponse", None], data)

        run = _parse_run(d.pop("run"))

        job_with_run_response = cls(
            id=id,
            start=start,
            end=end,
            state=state,
        ...
        job_with_run_response.additional_properties = d
