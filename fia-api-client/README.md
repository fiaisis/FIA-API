...
```python
from fia_api_client import Client
...
```python
from fia_api_client import AuthenticatedClient
...
1. Any endpoint which did not have a tag will be in `fia_api_client.api.default`
